...
function userMessage(error: unknown) {
  ...
  if (lower.includes("redirect") || lower.includes("oauth")) return "Google sign-in needs an authorized callback. The administrator must save the Supabase Google callback listed in the deployment guide, then retry.";
...
export default function LoginScreen() {
  ...
  const busy = submitting !== null || retrying;
  ...
  const submit = async () => {
    ...
    setMessage(null); setSubmitting("password");
    try {
      if (mode === "create") {
