...
const certificateTemplate = require("../../assets/certificates/online-university-certificate-template.png");
...
const styles = StyleSheet.create({
  ...
  certificate: { minHeight: 455, width: "100%", position: "relative" },
  templateImage: { opacity: 0.48 },
